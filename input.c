...
void initkeytab(tOutput* output)
{
	...
	const tKeyTab KeyTab[NUM_SPECIALKEYS]= {
			...
			{KEYF11, 0, 5, {0x1b, 0x5b, 0x32, 0x33, 0x7e, 0x00, 0x00, 0x00}, "KEYF11:", "This key is for going to the previous file"}, //TODO: wrong sequence
			{KEYF12, 0, 5, {0x1b, 0x5b, 0x32, 0x34, 0x7e, 0x00, 0x00, 0x00}, "KEYF12:", "This key is for going to the next file"}, //TODO: wrong sequence
